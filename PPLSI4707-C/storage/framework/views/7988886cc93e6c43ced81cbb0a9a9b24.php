...
<?php $__env->startSection('page-title', 'Ajukan Pinjaman'); ?>
...
<div class="page-header flex items-center justify-between">
    ...
    <a href="<?php echo e(route('anggota.pinjaman.index')); ?>" class="btn btn-outline">← Kembali</a>
</div>
...
<div style="display:grid;grid-template-columns:1fr 360px;gap:24px;align-items:start;">
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('anggota.pinjaman.store')); ?>" enctype="multipart/form-data" id="pinjaman-form">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div style="position:relative;">
                        ...
                        <input type="number" id="jumlah_pinjaman" name="jumlah_pinjaman"
                               class="form-control <?php echo e($errors->has('jumlah_pinjaman') ? 'is-invalid' : ''); ?>"
                               style="padding-left:40px;"
                               value="<?php echo e(old('jumlah_pinjaman')); ?>"
                               placeholder="500.000" min="500000" step="100000">
                    </div>
                    <?php $__errorArgs = ['jumlah_pinjaman'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <select id="tenor" name="tenor" class="form-control <?php echo e($errors->has('tenor') ? 'is-invalid' : ''); ?>">
                        <option value="">-- Pilih Tenor --</option>
                        <?php $__currentLoopData = [3,6,12,18,24,36,48,60]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($t); ?>" <?php echo e(old('tenor') == $t ? 'selected' : ''); ?>><?php echo e($t); ?> Bulan</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <textarea id="tujuan_pinjaman" name="tujuan_pinjaman"
                          class="form-control <?php echo e($errors->has('tujuan_pinjaman') ? 'is-invalid' : ''); ?>"
                          placeholder="Jelaskan tujuan pinjaman Anda (min. 20 karakter)..." rows="4"><?php echo e(old('tujuan_pinjaman')); ?></textarea>
                <?php $__errorArgs = ['tujuan_pinjaman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
function hitungSimulasi() {
    ...
    debounceTimer = setTimeout(async () => {
        ...
        try {
            const res  = await fetch('<?php echo e(route('anggota.pinjaman.simulasi')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MSI GF63\Dokumen\GitHub\projectPPLSI4707-C\PPLSI4707-C\resources\views/anggota/pinjaman/create.blade.php ENDPATH**/ ?>