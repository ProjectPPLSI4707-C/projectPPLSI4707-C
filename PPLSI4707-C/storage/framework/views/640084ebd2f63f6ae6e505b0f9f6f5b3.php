...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SKOTER'); ?> — Sistem Koperasi Terpadu</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <?php else: ?>
            <?php echo $__env->make('layouts.partials.sidebar-anggota', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
    </nav>
...
<div class="main-wrapper">
    <header class="topbar">
        ...
        <div class="topbar-right">
            <span class="topbar-date"><?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM Y')); ?></span>
        </div>
    </header>
...
<?php /**PATH C:\Users\MSI GF63\Dokumen\GitHub\projectPPLSI4707-C\PPLSI4707-C\resources\views\layouts\app.blade.php ENDPATH**/ ?>