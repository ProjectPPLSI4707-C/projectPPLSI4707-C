...
<a href="<?php echo e(route('anggota.angsuran.create')); ?>" class="nav-item <?php echo e(request()->routeIs('anggota.angsuran.create') ? 'active' : ''); ?>">
...
<a href="<?php echo e(route('anggota.profile.edit')); ?>" class="nav-item <?php echo e(request()->routeIs('anggota.profile.*') ? 'active' : ''); ?>">
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
    Edit Profil
</a>
<?php /**PATH D:\SEMESTER 5\github\projectPPLSI4707-C\resources\views/layouts/partials/sidebar-anggota.blade.php ENDPATH**/ ?>