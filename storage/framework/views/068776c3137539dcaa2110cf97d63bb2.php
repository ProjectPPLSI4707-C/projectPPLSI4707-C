...
<div class="profile-container">
    ...
    <div class="profile-section">
        ...
        <div class="profile-section-body">
            <form method="POST" action="<?php echo e(route('anggota.profile.update')); ?>" enctype="multipart/form-data" id="profileForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="photo-upload-area" id="photoDropZone">
                        <div class="photo-upload-preview" id="photoPreview">
                            <?php if($user->profile_photo): ?>
                                <img src="<?php echo e(asset('storage/' . $user->profile_photo)); ?>" alt="Foto Profil" id="previewImage">
                            <?php else: ?>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="Contoh: 08123456789">
...
unset($__errorArgs, $__bag); ?>"
                                  rows="3" placeholder="Masukkan alamat lengkap Anda"><?php echo e(old('address', $user->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="profile-section">
        ...
        <div class="profile-section-body">
            <form method="POST" action="<?php echo e(route('anggota.profile.password')); ?>" id="passwordForm">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\SEMESTER 5\github\projectPPLSI4707-C\resources\views/anggota/profile/edit.blade.php ENDPATH**/ ?>